...
import com.github.gtbluesky.gles.shape.*
import javax.microedition.khronos.egl.EGLConfig
import javax.microedition.khronos.opengles.GL10

class SkySphereActivity : AppCompatActivity(), SensorEventListener {
...
//        glView.setBackgroundColor(Color.TRANSPARENT)
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        ...
        if (shape is SkySphere) {
            (shape as SkySphere).setRotateMatrix(rotateMatrix)
