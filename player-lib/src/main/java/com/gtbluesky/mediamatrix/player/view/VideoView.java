...
import com.gtbluesky.mediamatrix.player.util.GLES2Util;
...
public class VideoView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private void initRenderYUV() {
        ...
        program_yuv = GLES2Util.buildProgramFromResource(context, R.raw.vertex_shader, R.raw.fragment_shader);
